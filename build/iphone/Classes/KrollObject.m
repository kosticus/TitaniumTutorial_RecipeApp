...
//@interface recipeappObject : NSObject
//@end

@interface recipeappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[recipeappObject class]])
		{
			for (NSString *key in [[(recipeappObject*)o modules] allKeys])
			{
