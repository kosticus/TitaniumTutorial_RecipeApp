...
// in simulator we redefine to format for recipeapp Developer console
...
{\
	NSString * exceptionName = [@"org.recipeapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.recipeapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIrecipeappNativeItemNone = -1, 
	UIrecipeappNativeItemSpinner = -2,
	UIrecipeappNativeItemProgressBar = -3,
	
	UIrecipeappNativeItemSlider = -4,
	UIrecipeappNativeItemSwitch = -5,
	UIrecipeappNativeItemMultiButton = -6,
	UIrecipeappNativeItemSegmented = -7,
	
	UIrecipeappNativeItemTextView = -8,
	UIrecipeappNativeItemTextField = -9,
	UIrecipeappNativeItemSearchBar = -10,
	
	UIrecipeappNativeItemPicker = -11,
	UIrecipeappNativeItemDatePicker = -12,
	
	UIrecipeappNativeItemInfoLight = -13,
	UIrecipeappNativeItemInfoDark = -14,
	
	UIrecipeappNativeItemDisclosure = -15,
	
	UIrecipeappNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all recipeapp instances of
