...
@interface recipeappObject : KrollCoverageObject {
#else
@interface recipeappObject : KrollObject {
#endif
@private
...
extern NSString * recipeapp$ModuleRequireFormat;
